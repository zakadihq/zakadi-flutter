// packages/zakadi_sdk_ios/pigeons/messages.dart
// The Android package holds identical declarations; only @ConfigurePigeon differs.
import 'package:pigeon/pigeon.dart';

// Keeps the closing `))` on its own line for tool/pigeons.sh (D75); the directive stands alone.
// dart format off
@ConfigurePigeon(PigeonOptions(
  dartPackageName: 'zakadi_sdk_ios',
  dartOut: 'lib/src/messages.g.dart',
  // dartTestOut and dartHostTestHandler still generate the test API (D75).
  // ignore: deprecated_member_use
  dartTestOut: 'test/test_api.g.dart',
  swiftOut: 'ios/zakadi_sdk_ios/Sources/zakadi_sdk_ios/Messages.g.swift',
  swiftOptions: SwiftOptions(errorClassName: 'ZakadiPigeonError'),
